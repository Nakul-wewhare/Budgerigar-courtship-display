...
%% do cross tabulation on between coloum 2 and 3 of data_2_0_0_2 for co occurance counts with percentage 
...
cross_tabulation = cross_tabulation(1:8,1:11);
...
% Set labels
h.XDisplayLabels = [labelforcount{1:11, 1}; 'Percentage'];
h.YDisplayLabels = [labelforcount{14:21, 1}; 'Percentage'];
