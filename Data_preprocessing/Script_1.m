...
%% this is the main script for data preprocessing to convert raw annotations to a form log odds analysis later
...
% for video data we process further and divide into 4 types. 
% 1) all behaviour except movement - add silence later ## we choose this in
% final analysis
...
%run script1_1 using treatment 1 and get data files in the format Data_treat no(1 in our case)_indivualID_day number( 0 = both days, 1 = first and 2 = second )   
